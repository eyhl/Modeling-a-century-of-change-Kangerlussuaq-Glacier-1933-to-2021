function [extrapolated_friction, extrapolated_pos, mae] = friction_random_field_model(md, cs_min, friction_law, validate_flag)
    ...
    extrapolated_pos = find(ContourToNodes(md.mesh.x, md.mesh.y, '/home/eyhli/IceModeling/work/lia_kq/Exp/1900_extrapolation_area.exp', 2));
    ...
    friction_validation_pos = find(ContourToNodes(md.mesh.x, md.mesh.y, '/home/eyhli/IceModeling/work/lia_kq/Exp/extrapolation_utils/friction_validation.exp', 2));

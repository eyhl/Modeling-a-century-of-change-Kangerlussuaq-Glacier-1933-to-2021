function [extrapolated_friction, extrapolated_pos, mae] = friction_exponential_model(md, cs_min, friction_law, validate_flag)
    ...
    friction_data_pos = find(ContourToNodes(md.mesh.x, md.mesh.y, '/home/eyhli/IceModeling/work/lia_kq/Exp/extrapolation_utils/friction_data_large.exp', 2));
    ...
    extrapolated_pos = find(ContourToNodes(md.mesh.x, md.mesh.y, '/home/eyhli/IceModeling/work/lia_kq/Exp/extrapolation_domain/1900_extrapolation_area_slim.exp', 2));

function [md] = temperature_correlation_model(md, M, add_constant, validate_flag)
    ...
    data_pos = find(ContourToNodes(md.mesh.x, md.mesh.y, '/home/eyhli/IceModeling/work/lia_kq/Exp/extrapolation_utils/temperature_data.exp', 2));
    val_pos = find(ContourToNodes(md.mesh.x, md.mesh.y, '/home/eyhli/IceModeling/work/lia_kq/Exp/extrapolation_utils/temperature_validation.exp', 2));
    ...
    if validate_flag
        ...
        colormap('turbo')
        expdisp('/home/eyhli/IceModeling/work/lia_kq/Exp/extrapolation_utils/temperature_data.exp', 'linewidth', 1, 'linestyle', 'r--')
        expdisp('/home/eyhli/IceModeling/work/lia_kq/Exp/extrapolation_utils/temperature_validation.exp', 'linewidth', 1, 'linestyle', 'r--')

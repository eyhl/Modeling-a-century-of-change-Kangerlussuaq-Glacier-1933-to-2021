function [md] = reconstruct_racmo(md, start_time, final_time, ref_start_time, ref_end_time, the_files)
    ...
    pos = find(ContourToNodes(md.mesh.x, md.mesh.y, '/home/eyhli/IceModeling/work/lia_kq/Exp/extrapolation_utils/ref_racmo_front.exp', 2));             
    ...
    pos2 = find(ContourToNodes(md.mesh.x, md.mesh.y, '/home/eyhli/IceModeling/work/lia_kq/Exp/extrapolation_domain/1900_extrapolation_area_smb.exp', 2));
